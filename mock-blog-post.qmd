...
Here we are going to try to learn whether each coach is in near zero play regime. We could really make this complicated by adding more and more covariates to our `w_coach_logit` param. Instead I just used a passing rate to keep it kind of simple. 
